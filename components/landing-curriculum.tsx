...
import { capabilitiesConfig } from "@/lib/landing-content";
...
export function LandingCurriculum() {
        ...
        (entries) => {
          entries.forEach((entry) => {
            if (entry.isIntersecting) {
              gsap.to(item, { opacity: 1, y: 0, duration: 1.0, delay: index * 0.15, ease: "power3.out" });
  ...
  return (
    <section id="curriculum" className="relative" style={{ padding: "150px 5vw", minHeight: "100vh" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div className="mb-20" style={{ width: "100%", height: 1, background: "rgba(18, 40, 63, 0.12)" }} />
          ...
          {capabilitiesConfig.items.map((discipline, i) => (
            ...
            >
              <div style={{ flex: "0 0 70%" }}>
                <h3
                  style={{
                    ...
                    color: hoveredIndex === i ? "#0d5ab0" : "#12283f",
                    margin: 0,
                    textWrap: "balance",
              ...
              >
                ...
                {discipline.image && (
                  // eslint-disable-next-line @next/next/no-img-element -- imagen dentro de un contenedor de altura fluida (hover reveal), objectFit: cover
                  <img
