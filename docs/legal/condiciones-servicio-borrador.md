# CONDICIONES DEL SERVICIO Y DE LA SUSCRIPCIÓN — [E-IRENE] S.A.S.
...
> ellos:
>
> 1. **Consentimiento y términos de vinculación del Profesional**
>    (`consentimiento-profesional-borrador.md`): licencia de uso, habilitación, responsabilidad
>    clínica, encargo del tratamiento, terminación por incumplimiento y limitación de
>    responsabilidad.
> 2. **Aviso de privacidad** (`aviso-privacidad-borrador.md`): tratamiento de los datos del
>    Profesional.
>
> Cada cláusula describe lo que la plataforma **hace hoy**, contrastado con el código en septiembre
> de 2026. Donde hace falta una decisión que la plataforma todavía no toma, va entre corchetes.
>
> `[Se propone un documento separado, y no una cláusula dentro del aviso de privacidad, por dos
> razones: cambiar el aviso obliga a todos los profesionales a volver a aceptarlo, y estas
> condiciones solo aplican a quien paga.]`

**Versión:** `[2026-09-v1]` · **Vigente desde:** `[FECHA]`

---

## PRIMERA — Partes y objeto

Estas condiciones regulan la contratación de los planes de pago de la plataforma E-Irene entre
**`[E-IRENE] S.A.S.`**, NIT `[ ]`, domiciliada en Medellín (en adelante, **E-Irene**), y la persona
natural o jurídica que contrata un plan para su práctica o institución (en adelante, **el
Cliente**).

El Cliente actúa por medio del usuario con rol de administrador de su cuenta en la plataforma. Quien
acepta estas condiciones declara tener facultad para obligar al Cliente.

`[Confirmar si el profesional independiente que contrata para su consultorio es "consumidor" en los
términos del artículo 5 de la Ley 1480 de 2011. De eso dependen el derecho de retracto (cláusula
DÉCIMA) y buena parte de los deberes de información previa.]`

---

## SEGUNDA — Planes y precios
...
`[Confirmar con contador si el servicio causa IVA y si los precios de la tabla lo incluyen. Hoy la
plataforma cobra exactamente el valor de la tabla, sin sumar impuestos.]`

**2.3** Las funcionalidades de cada plan, por ejemplo el análisis con IA o los recordatorios por
...
acuerdo. Lo que ese acuerdo disponga prevalece sobre estas condiciones.

---

## TERCERA — Pago

**3.1** Los pagos se procesan por medio de **Wompi**, pasarela de pagos de un tercero. E-Irene no
...
cómo se entrega, y (b) qué constancia del pago y de estas condiciones recibe el Cliente, en
cumplimiento del artículo 50 de la Ley 1480 de 2011 si aplica.]`

---

## CUARTA — Ciclo de facturación y renovación automática

**4.1 Ciclo.** Cada plan pago se contrata por ciclos mensuales. El ciclo empieza el día y la hora
del pago que activó el plan, en hora de Colombia, y termina el mismo día y hora del mes siguiente.
Si ese día no existe en un mes (por ejemplo, el 31), el ciclo cambia el último día de ese mes, y en
los meses siguientes vuelve al día original.

**4.2 Plan Free.** En el plan Free no hay cobro. Sus límites se cuentan por ciclos mensuales que
...
**4.5 Medios de pago sin cobro automático.** Si el medio de pago usado no permite cobros
automáticos, la renovación no se cobra sola: el Cliente debe pagarla desde **Plan y facturación**
antes del fin del ciclo. Si no lo hace, aplica la cláusula QUINTA.

---

## QUINTA — Cobro no aprobado y período de gracia

**5.1** Si la renovación no se puede cobrar, el Cliente **conserva el plan durante cinco (5) días
calendario** contados desde el fin del ciclo pagado (período de gracia). La plataforma le muestra un
aviso con la fecha límite y la opción de pagar.

**5.2** Si durante la gracia se aprueba el cobro automático, el plan se renueva desde el fin del
ciclo anterior. Si en cambio el Cliente paga desde la plataforma, el plan se renueva por un ciclo
contado desde el día del pago, y ese día pasa a ser el inicio de sus ciclos siguientes.
...
`[Definir si E-Irene contacta al Cliente en ese caso y por qué medio. Hoy la plataforma no envía
correos sobre cobros fallidos: el aviso solo se ve dentro de ella.]`
...
contabilizan **de forma independiente**: basta alcanzar uno de ellos para que aplique lo previsto en
esta cláusula.

**6.2** Las horas de transcripción se cuentan por la duración de cada consulta transcrita, **una sola
vez por consulta**, aunque en una videollamada se transcriban por separado el audio del profesional
y el del paciente.

**6.3** Al alcanzar un límite:

- **(a) Consultas:** no se pueden iniciar consultas nuevas hasta el siguiente ciclo o hasta cambiar a
  un plan que lo permita.
- **(b) Horas de transcripción:** las consultas pueden realizarse, pero las nuevas no se transcriben
  ni generan análisis automático hasta el siguiente ciclo o hasta cambiar de plan.
- **(c) Profesionales y pacientes:** no se pueden agregar más; los ya registrados se conservan.
...
**8.1** El administrador de la cuenta puede cancelar la suscripción **en cualquier momento** desde
**Plan y facturación**, sin penalidad.
...
## NOVENA — Cambios de precio y de condiciones

**9.1** E-Irene puede modificar los precios, los límites o las funcionalidades de los planes. Un
precio nuevo solo aplica **desde la primera renovación posterior al aviso**, y E-Irene lo informará
con al menos `[treinta (30)]` días de anticipación dentro de la plataforma `[y al correo del
administrador]`, de modo que el Cliente pueda cancelar antes de que se le cobre.

`[Hoy la plataforma cobra cada renovación con el precio vigente en ese momento y no envía ningún
aviso previo. Para publicar esta cláusula hace falta implementar el aviso, o dejar fijo el precio
de cada Cliente hasta que se le notifique el cambio.]`

**9.2** Los cambios de estas condiciones se informan de la misma manera.

`[Definir si seguir usando el servicio después del aviso equivale a aceptar los cambios, o si se
pedirá una aceptación expresa en la plataforma, como ya ocurre con el aviso de privacidad.]`

---

## DÉCIMA — Derecho de retracto

`[Pendiente de la respuesta de la cláusula PRIMERA. Si el Cliente es consumidor, el artículo 47 de
la Ley 1480 de 2011 le permite retractarse de un servicio contratado a distancia dentro de los
cinco (5) días hábiles siguientes a la contratación, con devolución del dinero. Evaluar si aplica
alguna de sus excepciones, como la de los servicios cuya prestación empezó con el acuerdo del
consumidor, y definir cómo se ejerce: canal, plazo de devolución y qué pasa con el uso ya hecho del
servicio en ese plazo.]`

---

## UNDÉCIMA — Suspensión y terminación por parte de E-Irene

**11.1** La falta de pago **no** da lugar a suspensión: la cuenta pasa a Free conforme a la cláusula
QUINTA.

**11.2** La suspensión o terminación por incumplimiento de las obligaciones del Profesional, por
ejemplo falta de habilitación o uso indebido de la plataforma, se rige por el Consentimiento y
términos de vinculación del Profesional.

---

## DUODÉCIMA — Ley aplicable, contacto y prelación de documentos

**12.1** Estas condiciones se rigen por la ley colombiana.

`[Mecanismo de solución de conflictos: alinearlo con la cláusula UNDÉCIMA del Consentimiento del
Profesional.]`

**12.2** Contacto para asuntos de facturación: **hola@e-irene.co**.
`[Confirmar si habrá un correo específico de facturación.]`

**12.3** Si hay contradicción entre documentos: para las cuentas Enterprise prevalece su acuerdo
firmado; en lo comercial prevalecen estas condiciones; y en licencia, habilitación, responsabilidad
y datos prevalece el Consentimiento del Profesional.

---

## ACEPTACIÓN

El Cliente acepta estas condiciones de forma electrónica y antes de pagar, marcando la casilla
correspondiente en **Plan y facturación**. E-Irene conserva como prueba la versión y la huella
(hash) del texto aceptado, el usuario que aceptó, la fecha y la hora, la dirección IP y el
navegador, con el valor que la Ley 527 de 1999 reconoce a los mensajes de datos.

`[Propuesta de implementación: el mismo esquema probatorio del aviso de privacidad (versión, hash,
IP, navegador y marca temporal). La tabla que hoy guarda esas aceptaciones registra un solo
documento, así que habría que distinguir el tipo de documento o crear una tabla propia. Una versión
nueva de estas condiciones se pediría solo a quien tiene un plan pago o va a pagar, no a todas las
cuentas.]`
...
1. **¿El Cliente es consumidor?** (PRIMERA y DÉCIMA). Define si aplican el retracto y los deberes de
